        ...
        <div className="flex flex-col items-center h-full">
            ...
            <div className="p-6 bg-blue-100 h-1/2 w-full flex flex-col justify-between">
                ...
                <div className="flex space-x-2 mt-3 justify-center">
                    <span className="px-3 py-1 bg-gray-200 text-sm rounded-xl">Assistant</span>
                    <span className="px-3 py-1 bg-gray-200 text-sm rounded-xl">AI</span>
                    <span className="px-3 py-1 bg-gray-200 text-sm rounded-xl">RAG</span>
                </div>
            </div>
        </div>
    </div>
